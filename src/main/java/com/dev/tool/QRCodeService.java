...
public class QRCodeService {
    ...
    public static boolean insertQRCode(String qrCode, String storeId) {
    ...
    public static boolean insertQRCodeList(List<String> qrCodes, String storeId) {
        String sql = "INSERT INTO qr_codes(qr_code, store_id) VALUES(?, ?)";
        try (Connection conn = SQLiteConnection.getConnection();
             PreparedStatement pstmt = conn.prepareStatement(sql)) {
    ...
    public static boolean deleteQRCode(String qrCode, String storeId) {
    ...
    public static boolean isQRCodeExists(String qrCode, String storeId) {
    ...
    public static int getCountQRCodeByStoreId(String storeId) {
    ...
    public static List<String> getQRCodesByStoreId(String storeId, int limit) {
    ...
    public static void deleteQRCodesByStoreId(String storeId, int count) {
